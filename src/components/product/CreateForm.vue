  ...
  <div class="demo-image__placeholder">
          ...
          <div class="box-create-category">
            <div class="category-signup-box">
              ...
              <p v-for="c in form.categories" :key="c.category_code">
                ...
                <br />
                Image: {{ c.imageLink }} <br />
                Category Code: {{ c.category_code }} <br />
                -----------------------------------------
              </p>
            </div>
          </div>
    ...
    <section>
      <el-dialog v-model="isVisibleImage" title="Inject" width="500" center>
        <span> Input your link at here! </span>
        ...
        <template #footer>
          <div class="dialog-footer">
            ...
            <el-button type="primary" @click="inputImage(inputLinkImage)"> Confirm </el-button>
          </div>
        </template>
      </el-dialog>
    </section>
...
const category = reactive<Category>({
  ...
  name: '',
  category_code: '',
  imageLink: inputLinkImageCategory.value
    ? inputLinkImage.value
    : 'https://cdn.tgdd.vn/Files/2015/09/09/698241/zalo20.jpg',
  status: 'UNAVAILABLE',
  description: ''
})
...
const rules = {
  ...
  product_code: [{ required: true, message: 'Please input product code', trigger: 'blur' }],
  quantity: [{ required: true, message: 'Please input quantity', trigger: 'blur' }],
  category_code: [{ required: true, message: 'Please input category code', trigger: 'blur' }]
}
